...
public class CD extends Audio { //class CD is a subclass of Audio
	...
	public int getPrice(){ //getter method to return Price of CD as an int
	...
	public String getType(){ //getter method to return Audio type as String
		return "CD";  //method returns the Audio type as a String
	}
